...
import { Lightbulb, ChevronRight, Eye, EyeOff, AlertCircle, CheckCircle } from 'lucide-react';
...
export function LabHints({
  ...
  return (
    <div className={`bg-white rounded-lg shadow-sm overflow-hidden ${className}`}>
        ...
        <div className="divide-y divide-gray-100">
          {hints.map((hint) => (
            <div key={hint.id} className="p-4">
              ...
              {availablePoints < hint.cost && !revealedHints.includes(hint.id) && (
      ...
      {hints.some(h => h.type === 'solution') && !taskCompleted && (
